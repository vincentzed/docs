...
<Warning>
  LFM2 and LFM2.5 VL models currently do not work with Ollama. Our team has opened [this PR](https://github.com/ollama/ollama/pull/14069), that once merged will solve the issue. Do not attempt to use Ollama with LFM2 and LFM2.5 VL models until this PR gets merged into ollama:main branch.
</Warning>
