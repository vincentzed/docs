...
```
git clone https://github.com/Liquid4All/cookbook.gitcd cookbook/examples/car-maker-identification
```
...
```
make evaluate config=eval_lfm_450M_raw_generation.yamlmake evaluate config=eval_lfm_1.6B_raw_generation.yamlmake evaluate config=eval_lfm_3B_raw_generation.yaml
```
...
```
make evaluate config=eval_lfm_450M_structured_generation.yamlmake evaluate config=eval_lfm_1.6B_structured_generation.yamlmake evaluate config=eval_lfm_3B_structured_generation.yaml
```
...
```
make fine-tune config=finetune_lfm_450M.yamlmake fine-tune config=finetune_lfm_1.6B.yamlmake fine-tune config=finetune_lfm_3B.yaml
```
...
```
git clone https://github.com/Liquid4All/cookbook.gitcd cookbook/examples/car-maker-identificationuv sync
```
...
```
configs/   ├── eval_lfm_450M_raw_generation.yaml   ├── eval_lfm_1.6B_raw_generation.yaml   └── eval_lfm_3B_raw_generation.yaml
```
...
```
class CarIdentificationOutputType(BaseModel):   pred_class: Literal[      "AM",      "Acura",      "Aston",      "Audi",      "BMW",      "Bentley",      "Bugatti",      "Buick",      ...      "Tesla",      "Toyota",      "Volkswagen",      "Volvo",      "smart",   ]
```

The 3 configuration files to run evaluation of LFM2-VL models with structured generation are:

```
configs/   ├── eval_lfm_450M_structured_generation.yaml   ├── eval_lfm_1.6B_structured_generation.yaml   └── eval_lfm_3B_structured_generation.yaml
```
