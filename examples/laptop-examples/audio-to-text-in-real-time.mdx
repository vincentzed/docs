---
title: "Audio-to-text transcription CLI"
---
...
1. Clone the repository
   ...
   ```
   git clone https://github.com/Liquid4All/cookbook.gitcd cookbook/examples/audio-transcription-cli
   ```
...
![](/images/examples/laptop-examples/assets/images/diagram-b7192887b0c9de51d04c0c2700cfaa71.gif)

## llama.cpp support for audio models[​](#llamacpp-support-for-audio-models "Direct link to llama.cpp support for audio models")
...
## Further improvements[​](#further-improvements "Direct link to Further improvements")
...
[Edit this page](https://github.com/Liquid4All/docs/tree/main/examples/laptop-examples/audio-to-text-in-real-time.mdx)
