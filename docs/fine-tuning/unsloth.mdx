---
title: "Unsloth"
description: "Unsloth is a library that makes fine-tuning LLMs 2-5x faster and uses 70% less memory through optimized kernels and efficient memory management."
---

<Tip>
  Use Unsloth for 2-5x faster training with optimized kernels, 70% less memory usage, and utilities for quantization and quick inference.
</Tip>
...
[![Colab link](/images/lfm/fine-tuning/production/uploads/61b8e2ba285851687028d395/vlOyMEjwHa_b_LXysEu2E.png)](https://colab.research.google.com/drive/1HROdGaPFt1tATniBcos11-doVaH7kOI3?usp=sharing)
...
<Accordion title="QLoRA (4-Bit Quantization)">
...
## Saving Models[​](#saving-models "Direct link to Saving Models")
...
[Edit this page](https://github.com/Liquid4All/docs/tree/main/lfm/fine-tuning/unsloth.md)
