...
<Tabs>
  ...
  <Tab title="llama.cpp">
    ...
    **Install:**
    ...
    Or download pre-built binaries from [llama.cpp releases](https://github.com/ggml-org/llama.cpp/releases).
    ...
    **Run:**
    ...
    For server deployment and advanced usage, see the [llama.cpp guide](/docs/inference/llama-cpp#vision-models).
  </Tab>
</Tabs>
